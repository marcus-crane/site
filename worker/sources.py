...
def books():
    ...
    book_data = parsers.goodreads(root)
    db.save('books', book_data)
...
def shows():
    ...
    headers = {'Content-Type': 'application/json',
               ...
               'trakt-api-key': settings.TRAKT}
    data = query_service(url, headers)
    show_data = parsers.trakt_shows(data)
    db.save('shows', show_data)
